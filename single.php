    ...
    <div id="post-container">
        <section id="blogpost">
            ...
            <div id="comments-section">
                ...
                $fields = array(
                    'author' => '<input placeholder="Name" id="author" type="text" value="'. esc_attr( $commenter['comment_author'] ) . '" size="30" '. $aria_req .'/>',
                    'email' => '<input placeholder="Email" id="email" type="text" value="'. esc_attr( $commenter['comment_author_email']) . '" size="30" '. $aria_req .' />'
                );

                $args = array('title_reply' => 'Share your thoughts',
                'fields' => $fields,
